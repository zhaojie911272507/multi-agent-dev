# 几个模式的组合示例 - 原文件: 几个模式的组合示例.py
# 责任链 + 策略 + 装饰器 + 代理

from knowledge.ai_design_mode.decorator import log_execution
from knowledge.ai_design_mode.chain_of_responsibility import TextCleaner, ResultFormatter, Handler
