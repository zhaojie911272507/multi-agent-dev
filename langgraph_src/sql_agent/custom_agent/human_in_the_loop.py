...
from langgraph_src.sql_agent.sql_database import db
from langgraph_src.sql_agent.init_chat_model import llm
from langgraph_src.sql_agent.tool_kit import tools
...
from langgraph_src.sql_agent.tool_kit import run_query_tool
...
if __name__ == '__main__':
    ...
    #     filename = "human-in-the-loop.png"
    #     # 保存到本地
    ...
    # Ensure Langfuse is properly initialized
    langfuse_handler.langfuse.auth_check()

    config = {"callbacks": [langfuse_handler], "configurable": {"thread_id": "1"}}

    question = "分析一下有哪些重要的临床试验的重要策略?，请使用中文回答"
